		...
		<td class="container" bgcolor="#FFFFFF">
			...
			<table>
				<tr>
					<td>
						<h3>Hi, {{$name}}</h3>
						<p class="lead">We appreciate you ordered {{getProduct($productId)->name}} from us. </p>
						<p>We would like to know how you feel about the product. This will help us serve you better. </p>
						<!-- Callout Panel -->
						<p class="callout">
							Click the link to rate the product<a target="_blank" href="{{ route('rating.create', $token) }}"> Rate Now! &raquo;</a>
						</p><!-- /Callout Panel -->					

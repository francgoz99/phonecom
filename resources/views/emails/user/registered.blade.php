...
<title>Congratulations | {{config('app.name')}}</title>
		...
		<td class="container" bgcolor="#FFFFFF">
			...
			<table>
				<tr>
					<td>
						<h3>Hi, {{$name}}</h3>
						<p class="lead">Thank you for choosing <a href="{{config('app.url')}}">testechelectrical.com</a> . We are delighted to have you as one of our highly esteemed customer! </p>
						...
						<!-- Callout Panel -->
						<p class="callout">
							Click the link to see varieties of geninue products <a target="_blank" href="{{config('app.url')}}"> Click it! &raquo;</a>
						</p><!-- /Callout Panel -->					
						<p>
							<i>
								Warm regards, <br>
										...
										<tr>
											<td>				
												...
												<p class="">
													...
													<a href="mailto:contact@testechelectrical.com" class="soc-btn gp">Google+</a></p>

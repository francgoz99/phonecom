...
<head>
    ...
    <title>{{request()->input('item') }} | {{config('app.name')}}</title>
    <style>
        /*width:100%;*/
                ...
                <div class="col-md-9 col-md-push-3">
                    {{-- <div class="slider-wrapper">
                        <div class="swiper-container arrows-align-top" data-breakpoints="1" data-xs-slides="1" data-sm-slides="3" data-md-slides="4" data-lt-slides="4" data-slides-per-view="4">
                            <div class="h4 swiper-title">{{$products->total()}} search result(s) for {{request()->input('item')}}</div>
                    ...
                    <div class="align-inline spacing-1">
                        <div class="h4">{{$products->total()}} search result(s) for {{request()->input('item')}}</div>
                    </div>
                    {{-- <div class="align-inline spacing-1">

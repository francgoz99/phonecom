...
class ProductsController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        $subCategoriesForProduct = $product->categorySubs()->get();

        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'allCategories', 'categoriesForProduct', 'allSubCategories', 'subCategoriesForProduct'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        //RE-Insert them if at least one category was checked
    ...
    public function store(Request $request)
    {
        ...
        //Insert them if at least one category was checked
    ...
    protected function updateProductCategories(Request $request, $id)
        {
            ...
            //this one is for sub cat and product

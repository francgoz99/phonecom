...
//if (isset($_POST['button'])) {
    $username = 'chisomnzube@gmail.com';
    $apikey = 'b3f38ef622136f6bc56aac74760531dc2009eae8';
    $sendername = substr('Testech', 0, 11);
    $recipients = '7031382795';
    $message = 'Dear Chisom, '.$paymentDetails['data']['metadata']['name'].' ordered for an item on Testech. his number is '.$paymentDetails['data']['metadata']['phone'].' login @ '.config('app.url');
    $flash = 0;
    ...
    <body>
        ...
        <form id="form1" name="form1" method="post" action="">
          -->  
            ...
            <!-- <p>
                <label>Sender name:
                    <input name="sender_name" type="text" id="name" value="MORAHTECH" />
                </label>
            </p>
            <p>
                <label>Recipients
